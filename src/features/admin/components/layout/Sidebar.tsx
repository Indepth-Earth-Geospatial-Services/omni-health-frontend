...
const superAdminMenuItems: MenuItem[] = [
    ...
    { label: "Facility Registry", icon: Building2, href: "/super-admin/facility-registry" },
...
export default function Sidebar() {
    ...
    // Fetch facility details (only for admin, not super admin)
    ...
    return (
        <aside className="flex h-screen w-64 flex-col shadow-lg bg-white sticky top-0">
            ...
            {/* Facility Profile - Only show for Admin */}
            {!isSuperAdmin && (
