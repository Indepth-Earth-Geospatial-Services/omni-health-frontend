  ...
  return useQuery<Record<string, any>, Error>({
    ...
    queryFn: async () => {
      ...
      return {
        ...
        qualification_date: { type: "string", nullable: true },
        date_first_appointment: { type: "string", nullable: true },
        confirmation_of_appointment: { type: "string", nullable: true },
        date_of_present_appointment: { type: "string", nullable: true },
        date_of_birth: { type: "string", nullable: true },
        lga_of_origin: { type: "string", nullable: true },
        years_in_present_station: { type: "number", nullable: true },
