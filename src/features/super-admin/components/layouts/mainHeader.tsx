  ...
  const [notifications, setNotifications] = useState<Notification[]>([
    {
      ...
      message: isSuperAdmin
        ? "Primary Healthcare has been registered"
        : "John Simon has been registered successfully",
      timestamp: "5 min ago",
      read: false,
    },
    {
      ...
      message: isSuperAdmin
        ...
        : "Appointment for Jane Smith at 2:00 PM",
    ...
    },
    {
      ...
      message: isSuperAdmin
        ? "Monthly analytics report is available"
        : "ICU capacity at 85%",
    ...
    },
    {
      ...
      message: isSuperAdmin
        ? "Dr. Smith assigned as facility admin"
        : "Lab results for Patient ID #12345",
