...
export default function Transparency() {
    return (
        <section className="py-20 sm:py-24 md:py-32 lg:py-40 bg-[#EEF6F5] overflow-x-hidden">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                {/* Section Header */}
                <ScrollReveal direction="up">
                    <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-medium text-center text-[#0A0D14] mb-3">
                        Healthcare Transparency Platform
                    </h2>
                </ScrollReveal>

                <ScrollReveal direction="up" delay={200}>
                    <p className="text-sm md:text-base lg:text-lg text-center text-gray-600 max-w-3xl mx-auto mb-8 sm:mb-12 md:mb-16 px-4">
